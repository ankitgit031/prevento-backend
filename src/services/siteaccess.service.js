...
const { SiteAccess } = require('../models');
const ApiError = require('../utils/ApiError');

/**
 * Create a customer
 * @param {Object} siteAccessBody
 * @returns {Promise<SiteAccess>}
 */
const createSiteAccess = async (siteAccessBody) => {
    return SiteAccess.create(siteAccessBody);
};
